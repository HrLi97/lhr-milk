<template>
    <div class="header-container">
      <div class="wrapper">
        ...
        <div class="left-wrapper v-link selected">
          <img style="width: 50px" width="50" height="50" src="~assets/images/loading.gif" @click="click()">
          <span class="text">饿了么奶茶小店</span>
        </div>
        <!-- 搜索框 -->
          ...
          <div class="hospital-search animation-show">
            <div id="search" style="display: block;">
              <el-autocomplete
                ...
                placeholder="输入奶茶的名称"
              >
                <span slot="suffix" class="search-btn v-link highlight clickable selected">
                  <img style="width: 50px" width="50" height="50" src="~assets/images/loading2.gif">
                </span>
              </el-autocomplete>
            </div>
          </div>
        ...
        <div class="right-wrapper">
          <span class="v-link clickable" style="width:200px;">帮助中心</span>
          ...
          <el-dropdown v-if="name != ''" @command="loginMenu">
            ...
            <el-dropdown-menu class="user-name-wrapper" slot="dropdown">
              ...
              <el-dropdown-item command="/order">消费记录</el-dropdown-item>
              <el-dropdown-item command="/order">订单管理</el-dropdown-item>
              <el-dropdown-item command="/order">积分兑换</el-dropdown-item>
      ...
      <!-- 登录弹出层 -->
      <el-dialog :visible.sync="dialogUserFormVisible" v-if="dialogUserFormVisible" style="text-align: left;" top="50px" :append-to-body="true"  width="460px" @close="closeDialog()">
        <div class="container">
  ...
  import smsApi from '@/api/user/userInfo'
  import hospitalApi from '@/api/hosp'
  import weixin from '@/api/user/weixin'
  
  const defaultDialogAtrr = {
    showLoginType: 'phone', // 控制手机登录与微信登录切换
    labelTips: '邮箱验证码登录', // 输入框提示
    inputValue: '', // 输入框绑定对象
  ...
  export default {
    ...
    methods: {
      ...
      login() {
        ...
        smsApi.login(this.userInfo)
            .then(response => {
            console.log(response.data)
            // 登录成功 设置cookie
            this.setCookies(response.data.name, response.data.token,response.data.weixin)
            })
            .catch(error => {
      ...
      querySearchAsync(queryString, cb) {
        ...
        hospitalApi.findHospByHosname(queryString).then(response => {
      ...
      weixinLogin() {
        ...
        weixin.getLoginParams().then(response => {
          var obj = new WxLogin({
            self_redirect:true,
